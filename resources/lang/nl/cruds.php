...
return [
    ...
    'clientManagementSetting' => [
        'title'          => 'Klantbeheer instellingen',
        'title_singular' => 'Klantbeheer instellingen',
    ],
    'currency' => [
        'title'          => 'Munteenheden',
    ...
    'incomeSource' => [
        'title'          => 'Inkomstbronnen',
        'title_singular' => 'Inkomstbron',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => ' ',
            'name'               => 'Name',
    ...
    'clientStatus' => [
        'title'          => 'Klant statussen',
        'title_singular' => 'Klant status',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'timeManagement' => [
        'title'          => 'Tijdmanagement',
        'title_singular' => 'Tijdmanagement',
    ],
    'timeWorkType' => [
        'title'          => 'Soorten werk',
        'title_singular' => 'Soort werk',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
    ...
    'timeReport' => [
        ...
        'reports'        => [
            'title'             => 'Rapporten',
            'title_singular'    => 'Rapport',
            'timeEntriesReport' => 'Tijdsinvoer rapport',
            'timeByProjects'    => 'Rapport per project',
            'timeByWorkType'    => 'Rapport per type werk',
        ],
    ],
    'expenseManagement' => [
        'title'          => 'Uitgavebeheer',
        'title_singular' => 'Uitgavebeheer',
    ],
    'expenseCategory' => [
    ...
    'incomeCategory' => [
        'title'          => 'Inkomsten categorieën',
        'title_singular' => 'Inkomsten categorie',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Name',
